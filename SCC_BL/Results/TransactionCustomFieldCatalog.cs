...
{
	public class TransactionCustomFieldCatalog : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_TRANSACTIONCUSTOMFIELDCATALOG;

		public const string TABLE_NAME = "TransactionCustomFieldCatalog";
		public const string PHRASE_WITH_GENRE = "el campo personalizado de la transacción";
		public const string PHRASE_WITH_POSESSION = "del campo personalizado de la transacción";
