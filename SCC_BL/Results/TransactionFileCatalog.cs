...
{
	public class TransactionFileCatalog : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_TRANSACTIONFILECATALOG;

		public const string TABLE_NAME = "TransactionFileCatalog";
		public const string PHRASE_WITH_GENRE = "el archivo de la transacción";
		public const string PHRASE_WITH_POSESSION = "del archivo de la transacción";
