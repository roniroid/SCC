...
{
	public class CustomField : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_CUSTOMFIELD;

		public const string TABLE_NAME = "CustomField";
		public const string PHRASE_WITH_GENRE = "el campo personalizado";
		public const string PHRASE_WITH_POSESSION = "del campo personalizado";
