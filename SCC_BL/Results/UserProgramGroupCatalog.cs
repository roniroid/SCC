...
{
	public class UserProgramGroupCatalog : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_USERPROGRAMGROUPCATALOG;

		public const string TABLE_NAME = "UserProgramGroupCatalog";
		public const string PHRASE_WITH_GENRE = "el grupo de programas en el usuario";
		public const string PHRASE_WITH_POSESSION = "del grupo de programas en el usuario";
		...
		public static class UpdateProgramGroupList
		{
			public enum CODE
			{
				SUCCESS,
			...
			public struct Success
			{
				...
				public const Notification.LogLevel LOCAL_LOG_LEVEL = Notification.LogLevel.INFO;
				public const string LOCAL_LOG = "Se actualizó la lista de grupos de programas para el grupo de manera correcta";

				public const string DATABASE_LOG = "Grupos de programas actualizados correctamente";

				public const string MESSAGE_TITLE = "Éxito";
				public const string MESSAGE_CONTENT = "Se actualizó la lista de grupos de programas para el grupo de manera correcta";
			};
			...
			public struct Error
			{
				...
				public const Notification.LogLevel LOCAL_LOG_LEVEL = Notification.LogLevel.ERROR;
				public const string LOCAL_LOG = "Ha ocurrido un error al actualizar la lista de grupos de programas.\r\n\tExcepción: " + REPLACE_EXCEPTION_MESSAGE;

				public const string DATABASE_LOG = "ERROR - Ha ocurrido un error al actualizar la lista de grupos de programas.\r\n\tExcepción: " + REPLACE_EXCEPTION_MESSAGE;

				public const string MESSAGE_TITLE = "Error";
				public const string MESSAGE_CONTENT = "Ha ocurrido un error al actualizar la lista de grupos de programas";
			};
		}
	}
}