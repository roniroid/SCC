...
{
	public class AttributeValueCatalog : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_ATTRIBUTEVALUECATALOG;

		public const string TABLE_NAME = "AttributeValueCatalog";
		public const string PHRASE_WITH_GENRE = "el valor atributo";
		public const string PHRASE_WITH_POSESSION = "del valor atributo";
