...
{
	public class TransactionAttributeCatalog : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_TRANSACTIONATTRIBUTECATALOG;

		public const string TABLE_NAME = "TransactionAttributeCatalog";
		public const string PHRASE_WITH_GENRE = "el atributo de la transacción";
		public const string PHRASE_WITH_POSESSION = "del atributo de la transacción";
