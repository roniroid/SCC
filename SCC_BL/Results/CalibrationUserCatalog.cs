...
{
	public class CalibrationUserCatalog : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_CALIBRATIONUSERCATALOG;

		public const string TABLE_NAME = "CalibrationUserCatalog";
		public const string PHRASE_WITH_GENRE = "el usuario de la calibración";
		public const string PHRASE_WITH_POSESSION = "del usuario de la calibración";
