...
{
	public class CalibrationGroupCatalog : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_CALIBRATIONGROUPCATALOG;

		public const string TABLE_NAME = "CalibrationGroupCatalog";
		public const string PHRASE_WITH_GENRE = "el grupo de calibración";
		public const string PHRASE_WITH_POSESSION = "del grupo de calibración";
