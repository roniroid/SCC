...
{
	public class Catalog : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_CATALOG;

		public const string TABLE_NAME = "Catalog";
		public const string PHRASE_WITH_GENRE = "el elemento de catálogo";
		public const string PHRASE_WITH_POSESSION = "del elemento de catálogo";
