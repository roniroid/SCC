...
{
	public class Attribute : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = DBValues.Catalog.ELEMENT.ELEMENT_ATTRIBUTE;

		public const string TABLE_NAME = "Attribute";
		public const string PHRASE_WITH_GENRE = "el atributo";
		public const string PHRASE_WITH_POSESSION = "del atributo";
		...
		public static class UpdateAttributeValueCatalogList
		{
			public enum CODE
			{
				SUCCESS,
			...
			public struct Success
			{
				...
				public const Notification.LogLevel LOCAL_LOG_LEVEL = Notification.LogLevel.INFO;
				public const string LOCAL_LOG = "Se actualizó la lista de valores para el atributo de manera correcta";

				public const string DATABASE_LOG = "Valores actualizados correctamente";

				public const string MESSAGE_TITLE = "Éxito";
				public const string MESSAGE_CONTENT = "Se actualizó la lista de valores para el atributo de manera correcta";
			};
			...
			public struct Error
			{
				...
				public const Notification.LogLevel LOCAL_LOG_LEVEL = Notification.LogLevel.ERROR;
				public const string LOCAL_LOG = "Ha ocurrido un error al actualizar la lista de valores. \r\n\tExcepción: " + REPLACE_EXCEPTION_MESSAGE;

				public const string DATABASE_LOG = "ERROR - Ha ocurrido un error al actualizar la lista de valores. \r\n\tExcepción: " + REPLACE_EXCEPTION_MESSAGE;

				public const string MESSAGE_TITLE = "Error";
				public const string MESSAGE_CONTENT = "Ha ocurrido un error al actualizar la lista de valores";
			};
		}
	}
}