...
{
	public class Program : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_PROGRAM;

		public const string TABLE_NAME = "Program";
		public const string PHRASE_WITH_GENRE = "el programa";
		public const string PHRASE_WITH_POSESSION = "del programa";
		...
		public struct Reactivate
		{
			...
			public struct Success
			{
				...
				public const Notification.LogLevel LOCAL_LOG_LEVEL = Notification.LogLevel.INFO;
				public const string LOCAL_LOG = "Reactivación del elemento de \"" + TABLE_NAME + "\" exitoso.\r\n\tDatos previos del objeto: " + REPLACE_JSON_INFO;

				public const string DATABASE_LOG = "Reactivación " + PHRASE_WITH_POSESSION + " exitoso.\r\n\tDatos previos del objeto: " + REPLACE_JSON_INFO;

				public const string MESSAGE_TITLE = "Éxito";
				public const string MESSAGE_CONTENT = "Se ha reactivado " + PHRASE_WITH_GENRE + " correctamente";
			}
			...
			public struct Error
			{
				...
				public const Notification.LogLevel LOCAL_LOG_LEVEL = Notification.LogLevel.ERROR;
				public const string LOCAL_LOG = "Ha ocurrido un error al reactivar el elemento de \"" + TABLE_NAME + "\".\r\n\tExcepción: " + REPLACE_EXCEPTION_MESSAGE;

				public const string DATABASE_LOG = "Hubo un error al reactivar " + PHRASE_WITH_POSESSION + ".\r\n\tExcepción: " + REPLACE_EXCEPTION_MESSAGE;

				public const string MESSAGE_TITLE = "Error";
				public const string MESSAGE_CONTENT = "Ha ocurrido un error al reactivar " + PHRASE_WITH_GENRE + "\r\n\tExcepción: " + REPLACE_EXCEPTION_MESSAGE;
			}
        }
        ...
        public static class UpdateProgramFormCatalogList
        {
            ...
            public struct Success
            {
                ...
                public const Notification.LogLevel LOCAL_LOG_LEVEL = Notification.LogLevel.INFO;
                public const string LOCAL_LOG = "Se actualizó la lista de formularios para el programa de manera correcta";

                public const string DATABASE_LOG = "Formularios actualizados correctamente";

                public const string MESSAGE_TITLE = "Éxito";
                public const string MESSAGE_CONTENT = "Se actualizó la lista de formularios para el programa de manera correcta";
            };
            ...
            public struct Error
            {
                ...
                public const Notification.LogLevel LOCAL_LOG_LEVEL = Notification.LogLevel.ERROR;
                public const string LOCAL_LOG = "Ha ocurrido un error al actualizar la lista de formularios.\r\n\tExcepción: " + REPLACE_EXCEPTION_MESSAGE;

                public const string DATABASE_LOG = "ERROR - Ha ocurrido un error al actualizar la lista de formularios.\r\n\tExcepción: " + REPLACE_EXCEPTION_MESSAGE;

                public const string MESSAGE_TITLE = "Error";
                public const string MESSAGE_CONTENT = "Ha ocurrido un error al actualizar la lista de formularios";
            };
        }
    }
}