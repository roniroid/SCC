...
{
	public class UserSupervisorCatalog : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_USERSUPERVISORCATALOG;

		public const string TABLE_NAME = "UserSupervisorCatalog";
		public const string PHRASE_WITH_GENRE = "el supervisor del usuario";
		public const string PHRASE_WITH_POSESSION = "del supervisor del usuario";
