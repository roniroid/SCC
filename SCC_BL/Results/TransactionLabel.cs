...
{
	public class TransactionLabel : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_TRANSACTIONLABEL;

		public const string TABLE_NAME = "TransactionLabel";
