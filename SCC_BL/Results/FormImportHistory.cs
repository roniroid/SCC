...
{
	public class FormImportHistory : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_FORMIMPORTHISTORY;

		public const string TABLE_NAME = "FormImportHistory";
		public const string PHRASE_WITH_GENRE = "el elemento de historial de importación de formulario";
		public const string PHRASE_WITH_POSESSION = "del elemento de historial de importación de formulario";
