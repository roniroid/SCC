...
{
	public class Permission : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_PERMISSION;

		public const string TABLE_NAME = "Permission";
		public const string PHRASE_WITH_GENRE = "el permiso";
		public const string PHRASE_WITH_POSESSION = "del permiso";
