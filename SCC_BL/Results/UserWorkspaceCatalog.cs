...
{
	public class UserWorkspaceCatalog : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_USERWORKSPACECATALOG;

		public const string TABLE_NAME = "UserWorkspaceCatalog";
		public const string PHRASE_WITH_GENRE = "el puesto del usuario";
		public const string PHRASE_WITH_POSESSION = "del puesto del usuario";
