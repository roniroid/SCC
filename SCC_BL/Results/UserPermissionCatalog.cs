...
{
	public class UserPermissionCatalog : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_USERPERMISSIONCATALOG;

		public const string TABLE_NAME = "UserPermissionCatalog";
		public const string PHRASE_WITH_GENRE = "el permiso del usuario";
		public const string PHRASE_WITH_POSESSION = "del permiso del usuario";
