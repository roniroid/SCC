...
{
	public class CalibrationTransactionCatalog : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_CALIBRATIONTRANSACTIONCATALOG;

		public const string TABLE_NAME = "CalibrationTransactionCatalog";
		public const string PHRASE_WITH_GENRE = "la transacción de la calibración";
		public const string PHRASE_WITH_POSESSION = "de la transacción de la calibración";
