...
{
	public class CustomControl : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_CUSTOMCONTROL;

		public const string TABLE_NAME = "CustomControl";
		public const string PHRASE_WITH_GENRE = "el control personalizado";
		public const string PHRASE_WITH_POSESSION = "del control personalizado";
		...
		public struct Insert
		{
            ...
            public struct NotAllowedToCreateCustomFields
            {
                public const SCC_BL.DBValues.Catalog.ELEMENT METHOD_ELEMENT_CATEGORY = ELEMENT_CATEGORY;
                ...
                public const Notification.LogLevel LOCAL_LOG_LEVEL = Notification.LogLevel.INFO;
                public const string LOCAL_LOG = "Usted no cuenta con los permisos para crear campos personalizados";

                public const string DATABASE_LOG = "Usted no cuenta con los permisos para crear campos personalizados";

                public const string MESSAGE_TITLE = "Aviso";
                public const string MESSAGE_CONTENT = "Usted no cuenta con los permisos para crear campos personalizados";
            }
        }
		...
		public static class UpdateCustomControlValueCatalogList
		{
			public enum CODE
			{
				SUCCESS,
			...
			public struct Success
			{
				...
				public const Notification.LogLevel LOCAL_LOG_LEVEL = Notification.LogLevel.INFO;
				public const string LOCAL_LOG = "Se actualizó la lista de opciones para el control personalizado de manera correcta";

				public const string DATABASE_LOG = "Opciones actualizadas correctamente";

				public const string MESSAGE_TITLE = "Éxito";
				public const string MESSAGE_CONTENT = "Se actualizó la lista de opciones para el control personalizado de manera correcta";
			};
