...
{
	public class ProgramGroup : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_PROGRAMGROUP;

		public const string TABLE_NAME = "ProgramGroup";
		public const string PHRASE_WITH_GENRE = "el grupo de programas";
		public const string PHRASE_WITH_POSESSION = "del grupo de programas";
		...
		public struct Insert
		{
            ...
            public struct AlreadyExistsIdentifier
            {
                public const SCC_BL.DBValues.Catalog.ELEMENT METHOD_ELEMENT_CATEGORY = ELEMENT_CATEGORY;
                ...
                public const Notification.LogLevel LOCAL_LOG_LEVEL = Notification.LogLevel.ERROR;
                public const string LOCAL_LOG = "Registro fallido porque ya existe un grupo de programas con ese identificador. \r\n\t→ Datos del objeto: " + REPLACE_JSON_INFO;

                //public const string DATABASE_LOG = "ERROR - Ese identificador de grupo de programas ya se encuentra registrado";

                public const string MESSAGE_TITLE = "Error";
                public const string MESSAGE_CONTENT = "Ese identificador de grupo de programas ya se encuentra registrado";
            };

            public struct AlreadyExistsName
            {
                public const SCC_BL.DBValues.Catalog.ELEMENT METHOD_ELEMENT_CATEGORY = ELEMENT_CATEGORY;
                ...
                public const Notification.LogLevel LOCAL_LOG_LEVEL = Notification.LogLevel.ERROR;
                public const string LOCAL_LOG = "Registro fallido porque ya existe un grupo de programas con ese nombre. \r\n\t→ Datos del objeto: " + REPLACE_JSON_INFO;

                //public const string DATABASE_LOG = "ERROR - Ese nombre de grupo de programas ya se encuentra registrado";

                public const string MESSAGE_TITLE = "Error";
                public const string MESSAGE_CONTENT = "Ese nombre de grupo de programas ya se encuentra registrado";
            };
        }
		...
		public static class UpdateProgramList
		{
			...
			public struct Success
			{
				...
				public const Notification.LogLevel LOCAL_LOG_LEVEL = Notification.LogLevel.INFO;
				public const string LOCAL_LOG = "Se actualizó la lista de programas para el grupo de manera correcta";

				public const string DATABASE_LOG = "Programas actualizados correctamente";

				public const string MESSAGE_TITLE = "Éxito";
				public const string MESSAGE_CONTENT = "Se actualizó la lista de programas para el grupo de manera correcta";
			};
