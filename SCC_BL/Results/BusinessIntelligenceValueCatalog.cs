...
{
	public class BusinessIntelligenceValueCatalog : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_BUSINESSINTELLIGENCEVALUECATALOG;

		public const string TABLE_NAME = "BusinessIntelligenceValueCatalog";
		public const string PHRASE_WITH_GENRE = "el valor de campo de Inteligencia de Negocios";
		public const string PHRASE_WITH_POSESSION = "del valor de campo de Inteligencia de Negocios";
