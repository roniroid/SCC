...
{
	public class CustomControlValueCatalog : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_CUSTOMCONTROLVALUECATALOG;

		public const string TABLE_NAME = "CustomControlValueCatalog";
		public const string PHRASE_WITH_GENRE = "el valor de control personalizado";
		public const string PHRASE_WITH_POSESSION = "del valor de control personalizado";
