...
{
	public class Workspace : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_WORKSPACE;

		public const string TABLE_NAME = "Workspace";
		public const string PHRASE_WITH_GENRE = "el puesto";
		public const string PHRASE_WITH_POSESSION = "del puesto";
		...
		public struct Insert
		{
			...
			public struct ALREADY_EXISTS_IDENTIFIER
			{
				...
				public const string LOCAL_LOG = "No es posible ingresar ese identificador para el puesto.\r\n\tDatos del objeto: " + REPLACE_JSON_INFO;

				public const string DATABASE_LOG = "No es posible ingresar ese identificador para el puesto.\r\n\tDatos del objeto: " + REPLACE_JSON_INFO;

				public const string MESSAGE_TITLE = "Error";
				public const string MESSAGE_CONTENT = "No es posible ingresar ese identificador para el puesto";
			}
            ...
            public struct NotAllowedToCreateWorkspaces
            {
                public const SCC_BL.DBValues.Catalog.ELEMENT METHOD_ELEMENT_CATEGORY = ELEMENT_CATEGORY;
                ...
                public const Notification.LogLevel LOCAL_LOG_LEVEL = Notification.LogLevel.INFO;
                public const string LOCAL_LOG = "Usted no cuenta con los permisos para crear puestos de trabajo";

                public const string DATABASE_LOG = "Usted no cuenta con los permisos para crear puestos de trabajo";

                public const string MESSAGE_TITLE = "Aviso";
                public const string MESSAGE_CONTENT = "Usted no cuenta con los permisos para crear puestos de trabajo";
            }
        }
		...
		public struct Update
		{
			...
			public struct ALREADY_EXISTS_IDENTIFIER
			{
				...
				public const Notification.LogLevel LOCAL_LOG_LEVEL = Notification.LogLevel.ERROR;
				public const string LOCAL_LOG = "No es posible cambiar el identificador del puesto.\r\n\tDatos del objeto: " + REPLACE_JSON_INFO;

				public const string DATABASE_LOG = "No es posible cambiar el identificador del puesto.\r\n\tDatos del objeto: " + REPLACE_JSON_INFO;

				public const string MESSAGE_TITLE = "Error";
				public const string MESSAGE_CONTENT = "No es posible cambiar el identificador del puesto";
			}
            ...
            public struct NotAllowedToModifyWorkspaces
            {
                public const SCC_BL.DBValues.Catalog.ELEMENT METHOD_ELEMENT_CATEGORY = ELEMENT_CATEGORY;
                ...
                public const Notification.LogLevel LOCAL_LOG_LEVEL = Notification.LogLevel.INFO;
                public const string LOCAL_LOG = "Usted no cuenta con los permisos para modificar puestos de trabajo";

                public const string DATABASE_LOG = "Usted no cuenta con los permisos para modificar puestos de trabajo";

                public const string MESSAGE_TITLE = "Aviso";
                public const string MESSAGE_CONTENT = "Usted no cuenta con los permisos para modificar puestos de trabajo";
            }
        }
		...
		public struct Delete
		{
            ...
            public struct NotAllowedToDeleteWorkspaces
            {
                public const SCC_BL.DBValues.Catalog.ELEMENT METHOD_ELEMENT_CATEGORY = ELEMENT_CATEGORY;
                ...
                public const Notification.LogLevel LOCAL_LOG_LEVEL = Notification.LogLevel.INFO;
                public const string LOCAL_LOG = "Usted no cuenta con los permisos para eliminar puestos de trabajo";

                public const string DATABASE_LOG = "Usted no cuenta con los permisos para eliminar puestos de trabajo";

                public const string MESSAGE_TITLE = "Aviso";
                public const string MESSAGE_CONTENT = "Usted no cuenta con los permisos para eliminar puestos de trabajo";
            }
        }
	}
}