...
{
	public class RolPermissionCatalog : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_ROLPERMISSIONCATALOG;

		public const string TABLE_NAME = "RolPermissionCatalog";
		public const string PHRASE_WITH_GENRE = "el permiso del rol";
		public const string PHRASE_WITH_POSESSION = "del permiso del rol";
