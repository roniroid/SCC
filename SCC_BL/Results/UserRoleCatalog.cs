...
{
	public class UserRoleCatalog : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_USERROLECATALOG;

		public const string TABLE_NAME = "UserRoleCatalog";
		public const string PHRASE_WITH_GENRE = "el rol del usuario";
		public const string PHRASE_WITH_POSESSION = "del rol del usuario";
