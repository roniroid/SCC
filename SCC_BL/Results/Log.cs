...
{
	public class Log : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_LOG;

		public const string TABLE_NAME = "Log";
		public const string PHRASE_WITH_GENRE = "la bitácora";
		public const string PHRASE_WITH_POSESSION = "de la bitácora";
