...
{
	public class BasicInfo : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_BASICINFO;

		public const string TABLE_NAME = "BasicInfo";
		public const string PHRASE_WITH_GENRE = "el elemento de información";
		public const string PHRASE_WITH_POSESSION = "del elemento de información";
