...
{
	public class FormBIFieldCatalog : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = DBValues.Catalog.ELEMENT.ELEMENT_FORMBIFIELDCATALOG;

		public const string TABLE_NAME = "FormBIFieldCatalog";
		public const string PHRASE_WITH_GENRE = "el campo de Inteligencia de Negocios del formulario";
		public const string PHRASE_WITH_POSESSION = "del campo de Inteligencia de Negocios del formulario";
