...
namespace SCC_BL.Results
{
	...
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_PERSON;

		public const string TABLE_NAME = "Person";
		public const string PHRASE_WITH_GENRE = "la persona";
		public const string PHRASE_WITH_POSESSION = "de la persona";
		...
		public struct Update
		{
			...
			public struct AlreadyExists
			{
				...
				public const Notification.LogLevel LOCAL_LOG_LEVEL = Notification.LogLevel.ERROR;
				public const string LOCAL_LOG = "Edición del elemento de \"" + TABLE_NAME + "\" fallida, " + PHRASE_WITH_GENRE + " se encontró en el sistema.\r\n\tDatos del objeto: " + REPLACE_JSON_INFO;

				public const string DATABASE_LOG = "Hubo un error en la edición " + PHRASE_WITH_POSESSION + ", " + PHRASE_WITH_GENRE + " se encontró en el sistema.\r\n\tExcepción: " + REPLACE_EXCEPTION_MESSAGE;

				public const string MESSAGE_TITLE = "Error";
				public const string MESSAGE_CONTENT = "Ha ocurrido un error al editar " + PHRASE_WITH_GENRE + ", " + PHRASE_WITH_GENRE + " se encontró en el sistema.\r\n\tExcepción: " + REPLACE_EXCEPTION_MESSAGE;
			}
		}
