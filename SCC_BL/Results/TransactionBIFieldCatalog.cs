...
{
	public class TransactionBIFieldCatalog : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_TRANSACTIONBIFIELDCATALOG;

		public const string TABLE_NAME = "TransactionBIFieldCatalog";
		public const string PHRASE_WITH_GENRE = "el campo de Inteligencia de Negocios de la transacción";
		public const string PHRASE_WITH_POSESSION = "del campo de Inteligencia de Negocios de la transacción";
