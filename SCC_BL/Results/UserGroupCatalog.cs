...
{
	public class UserGroupCatalog : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_USERGROUPCATALOG;

		public const string TABLE_NAME = "UserGroupCatalog";
		public const string PHRASE_WITH_GENRE = "el grupo del usuario";
		public const string PHRASE_WITH_POSESSION = "del grupo del usuario";
