...
{
	public class TransactionCommentary : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_TRANSACTIONCOMMENTARY;

		public const string TABLE_NAME = "TransactionCommentary";
		public const string PHRASE_WITH_GENRE = "el comentario de la transacción";
		public const string PHRASE_WITH_POSESSION = "del comentario de la transacción";
