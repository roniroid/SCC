...
{
	public class UserProgramCatalog : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_USERPROGRAMCATALOG;

		public const string TABLE_NAME = "UserProgramCatalog";
		public const string PHRASE_WITH_GENRE = "el programa del usuario";
		public const string PHRASE_WITH_POSESSION = "del programa del usuario";
