...
{
	public class TransactionLabelCatalog : CommonElements
	{
		public const SCC_BL.DBValues.Catalog.ELEMENT ELEMENT_CATEGORY = SCC_BL.DBValues.Catalog.ELEMENT.ELEMENT_TRANSACTIONLABELCATALOG;

		public const string TABLE_NAME = "TransactionLabelCatalog";
		public const string PHRASE_WITH_GENRE = "la etiqueta de la transacción";
		public const string PHRASE_WITH_POSESSION = "de la etiqueta de la transacción";
