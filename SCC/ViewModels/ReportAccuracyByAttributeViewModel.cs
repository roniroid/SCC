...
namespace SCC.ViewModels
{
    public class ReportAccuracyByAttributeViewModel
    {
        ...
        public SCC_BL.Reports.Helpers.CustomControlByProgram CustomControlByProgram { get; set; } = null;

        public ReportAccuracyByAttributeViewModel()
        {
            this.CustomControlByProgram = new SCC_BL.Reports.Helpers.CustomControlByProgram();
        }
